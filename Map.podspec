#
#  Be sure to run `pod spec lint Map.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
      gkfld;gkl;fdkg;lfdkg;dlfjgkdfjgkldjfgkldjfgdflkgdlfgd
                   DESC
  ...
  #s.source       = { :git => "http://EXAMPLE/Map.git", :tag => "#{s.version}" }
  s.source       = { :git => "https://github.com/VictorerW/Map.git", :tag => "#{s.version}" }

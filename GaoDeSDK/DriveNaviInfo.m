...
-(void)calculateDriveRountWithStartPoint:(CLLocationCoordinate2D)startPoint endPoint:(CLLocationCoordinate2D)endPoint{
    ...
    [self.driverManager calculateDriveRouteWithStartPoints:@[startP] endPoints:@[endP] wayPoints:nil drivingStrategy:AMapNaviDrivingStrategySinglePrioritiseDistance];
